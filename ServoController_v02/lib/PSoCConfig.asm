...
export LoadConfig_servocontroller_v02
export _LoadConfig_servocontroller_v02
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_servocontroller_v02
	lcall	LoadConfigTBL_servocontroller_v02_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration servocontroller_v02
;
;    Load configuration registers for servocontroller_v02.
...
;               CUR_PP
;
_LoadConfig_servocontroller_v02:
 LoadConfig_servocontroller_v02:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_servocontroller_v02_Bank0
    mov     X, <LoadConfigTBL_servocontroller_v02_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_servocontroller_v02_Bank1
    mov     X, <LoadConfigTBL_servocontroller_v02_Bank1
