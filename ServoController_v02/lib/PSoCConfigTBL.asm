...
;       Instance name PWM16_1, Block Name PWM16_LSB(DBB00)
	...
	db		21h, 20h		;PWM16_1_PERIOD_LSB_REG(DBB00DR1)
	db		22h, dch		;PWM16_1_COMPARE_LSB_REG(DBB00DR2)
;       Instance name PWM16_1, Block Name PWM16_MSB(DBB01)
	...
	db		26h, 05h		;PWM16_1_COMPARE_MSB_REG(DBB01DR2)
...
;       Instance name PWM16_2, Block Name PWM16_LSB(DCB02)
	...
	db		29h, 20h		;PWM16_2_PERIOD_LSB_REG(DCB02DR1)
...
;       Instance name PWM16_2, Block Name PWM16_MSB(DCB03)
	...
	db		2dh, 4eh		;PWM16_2_PERIOD_MSB_REG(DCB03DR1)
...
;       Instance name PWM16_3, Block Name PWM16_LSB(DBB10)
	...
	db		31h, 20h		;PWM16_3_PERIOD_LSB_REG(DBB10DR1)
	db		32h, dch		;PWM16_3_COMPARE_LSB_REG(DBB10DR2)
;       Instance name PWM16_3, Block Name PWM16_MSB(DBB11)
	db		37h, 00h		;PWM16_3_CONTROL_MSB_REG(DBB11CR0)
	db		35h, 4eh		;PWM16_3_PERIOD_MSB_REG(DBB11DR1)
	db		36h, 05h		;PWM16_3_COMPARE_MSB_REG(DBB11DR2)
...
;       Instance name PWM16_4, Block Name PWM16_LSB(DCB12)
	...
	db		39h, 20h		;PWM16_4_PERIOD_LSB_REG(DCB12DR1)
	db		3ah, dch		;PWM16_4_COMPARE_LSB_REG(DCB12DR2)
;       Instance name PWM16_4, Block Name PWM16_MSB(DCB13)
	db		3fh, 00h		;PWM16_4_CONTROL_MSB_REG(DCB13CR0)
	db		3dh, 4eh		;PWM16_4_PERIOD_MSB_REG(DCB13DR1)
	db		3eh, 05h		;PWM16_4_COMPARE_MSB_REG(DCB13DR2)
;  Instance name PWM16_5, User Module PWM16
;       Instance name PWM16_5, Block Name PWM16_LSB(DBB30)
	db		53h, 00h		;PWM16_5_CONTROL_LSB_REG(DBB30CR0)
	db		51h, 20h		;PWM16_5_PERIOD_LSB_REG(DBB30DR1)
	db		52h, dch		;PWM16_5_COMPARE_LSB_REG(DBB30DR2)
;       Instance name PWM16_5, Block Name PWM16_MSB(DBB31)
	db		57h, 00h		;PWM16_5_CONTROL_MSB_REG(DBB31CR0)
	db		55h, 4eh		;PWM16_5_PERIOD_MSB_REG(DBB31DR1)
	db		56h, 05h		;PWM16_5_COMPARE_MSB_REG(DBB31DR2)
;  Instance name PWM16_6, User Module PWM16
;       Instance name PWM16_6, Block Name PWM16_LSB(DBB20)
	db		43h, 00h		;PWM16_6_CONTROL_LSB_REG(DBB20CR0)
	db		41h, 20h		;PWM16_6_PERIOD_LSB_REG(DBB20DR1)
	db		42h, dch		;PWM16_6_COMPARE_LSB_REG(DBB20DR2)
;       Instance name PWM16_6, Block Name PWM16_MSB(DBB21)
	db		47h, 00h		;PWM16_6_CONTROL_MSB_REG(DBB21CR0)
	db		45h, 4eh		;PWM16_6_PERIOD_MSB_REG(DBB21DR1)
	db		46h, 05h		;PWM16_6_COMPARE_MSB_REG(DBB21DR2)
;  Instance name PWM16_7, User Module PWM16
;       Instance name PWM16_7, Block Name PWM16_LSB(DCB22)
	db		4bh, 00h		;PWM16_7_CONTROL_LSB_REG(DCB22CR0)
	db		49h, 20h		;PWM16_7_PERIOD_LSB_REG(DCB22DR1)
	db		4ah, dch		;PWM16_7_COMPARE_LSB_REG(DCB22DR2)
;       Instance name PWM16_7, Block Name PWM16_MSB(DCB23)
	db		4fh, 00h		;PWM16_7_CONTROL_MSB_REG(DCB23CR0)
	db		4dh, 4eh		;PWM16_7_PERIOD_MSB_REG(DCB23DR1)
	db		4eh, 05h		;PWM16_7_COMPARE_MSB_REG(DCB23DR2)
...
;  Global Register values Bank 0
	...
	db		beh, 11h		; Row_1_OutputDrive_1 register (RDI1SRO1)
	...
	db		c6h, 02h		; Row_2_OutputDrive_1 register (RDI2SRO1)
	...
	db		cdh, 02h		; Row_3_OutputDrive_0 register (RDI3SRO0)
...
;       Instance name PWM16_2, Block Name PWM16_MSB(DCB03)
	db		2ch, 21h		;PWM16_2_FUNC_MSB_REG(DCB03FN)
...
;       Instance name PWM16_3, Block Name PWM16_MSB(DBB11)
	db		34h, 21h		;PWM16_3_FUNC_MSB_REG(DBB11FN)
...
;       Instance name PWM16_4, Block Name PWM16_MSB(DCB13)
	db		3ch, 21h		;PWM16_4_FUNC_MSB_REG(DCB13FN)
	db		3dh, 36h		;PWM16_4_INPUT_MSB_REG(DCB13IN)
	db		3eh, 47h		;PWM16_4_OUTPUT_MSB_REG(DCB13OU)
;  Instance name PWM16_5, User Module PWM16
;       Instance name PWM16_5, Block Name PWM16_LSB(DBB30)
	db		50h, 01h		;PWM16_5_FUNC_LSB_REG(DBB30FN)
	db		51h, 16h		;PWM16_5_INPUT_LSB_REG(DBB30IN)
	db		52h, 00h		;PWM16_5_OUTPUT_LSB_REG(DBB30OU)
;       Instance name PWM16_5, Block Name PWM16_MSB(DBB31)
	db		54h, 21h		;PWM16_5_FUNC_MSB_REG(DBB31FN)
	db		55h, 36h		;PWM16_5_INPUT_MSB_REG(DBB31IN)
	db		56h, 04h		;PWM16_5_OUTPUT_MSB_REG(DBB31OU)
;  Instance name PWM16_6, User Module PWM16
;       Instance name PWM16_6, Block Name PWM16_LSB(DBB20)
	db		40h, 01h		;PWM16_6_FUNC_LSB_REG(DBB20FN)
	db		41h, 16h		;PWM16_6_INPUT_LSB_REG(DBA20IN)
	db		42h, 40h		;PWM16_6_OUTPUT_LSB_REG(DBA20OU)
;       Instance name PWM16_6, Block Name PWM16_MSB(DBB21)
	db		44h, 21h		;PWM16_6_FUNC_MSB_REG(DBB21FN)
	db		45h, 36h		;PWM16_6_INPUT_MSB_REG(DBB21IN)
	db		46h, 45h		;PWM16_6_OUTPUT_MSB_REG(DBB21OU)
;  Instance name PWM16_7, User Module PWM16
;       Instance name PWM16_7, Block Name PWM16_LSB(DCB22)
	db		48h, 01h		;PWM16_7_FUNC_LSB_REG(DCB22FN)
	db		49h, 16h		;PWM16_7_INPUT_LSB_REG(DCB22IN)
	db		4ah, 40h		;PWM16_7_OUTPUT_LSB_REG(DCB22OU)
;       Instance name PWM16_7, Block Name PWM16_MSB(DCB23)
	db		4ch, 21h		;PWM16_7_FUNC_MSB_REG(DCB23FN)
	db		4dh, 36h		;PWM16_7_INPUT_MSB_REG(DCB23IN)
	db		4eh, 46h		;PWM16_7_OUTPUT_MSB_REG(DCB23OU)
;  Instance name UART_1, User Module UART
;       Instance name UART_1, Block Name RX(DCB33)
...
;  Global Register values Bank 1
	...
	db		e1h, c1h		; OscillatorControl_1 register (OSC_CR1)
