...
;  Global Symbols
;-----------------------------------------------
export  PWM8_12_EnableInt
export _PWM8_12_EnableInt
export  PWM8_12_DisableInt
export _PWM8_12_DisableInt
export  PWM8_12_Start
export _PWM8_12_Start
export  PWM8_12_Stop
export _PWM8_12_Stop
export  PWM8_12_WritePeriod
export _PWM8_12_WritePeriod
export  PWM8_12_WritePulseWidth
export _PWM8_12_WritePulseWidth
export  PWM8_12_bReadPulseWidth
export _PWM8_12_bReadPulseWidth
export  PWM8_12_bReadCounter
export _PWM8_12_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_12_ReadPulseWidth    ; deprecated
export _bPWM8_12_ReadPulseWidth    ; deprecated
export  bPWM8_12_ReadCounter       ; deprecated
export _bPWM8_12_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM8_12_WritePeriod:
_PWM8_12_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_12_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_12_WritePulseWidth:
_PWM8_12_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_12_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_12_bReadPulseWidth:
_PWM8_12_bReadPulseWidth:
 bPWM8_12_ReadPulseWidth:                        ; this name deprecated
_bPWM8_12_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_12_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_12_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_12_bReadCounter:
_PWM8_12_bReadCounter:
 bPWM8_12_ReadCounter:                           ; this name deprecated
_bPWM8_12_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM8_12_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_12_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_12_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_12_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_12_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM8_12_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM8_12_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM8_12_Start_M                               ;   then re-enable the PWM.
