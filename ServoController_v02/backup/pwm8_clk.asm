...
include "m8c.inc"
include "PWM8_CLK.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_CLK_EnableInt
export _PWM8_CLK_EnableInt
export  PWM8_CLK_DisableInt
export _PWM8_CLK_DisableInt
export  PWM8_CLK_Start
export _PWM8_CLK_Start
export  PWM8_CLK_Stop
export _PWM8_CLK_Stop
export  PWM8_CLK_WritePeriod
export _PWM8_CLK_WritePeriod
export  PWM8_CLK_WritePulseWidth
export _PWM8_CLK_WritePulseWidth
export  PWM8_CLK_bReadPulseWidth
export _PWM8_CLK_bReadPulseWidth
export  PWM8_CLK_bReadCounter
export _PWM8_CLK_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_CLK_ReadPulseWidth    ; deprecated
export _bPWM8_CLK_ReadPulseWidth    ; deprecated
export  bPWM8_CLK_ReadCounter       ; deprecated
export _bPWM8_CLK_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_DisableInt
;
;  DESCRIPTION:
...
;
 PWM8_CLK_DisableInt:
_PWM8_CLK_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_CLK_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_CLK_WritePeriod:
_PWM8_CLK_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_CLK_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_CLK_WritePulseWidth:
_PWM8_CLK_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_CLK_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_CLK_bReadPulseWidth:
_PWM8_CLK_bReadPulseWidth:
 bPWM8_CLK_ReadPulseWidth:                       ; this name deprecated
_bPWM8_CLK_ReadPulseWidth:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_CLK_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_CLK_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_CLK_bReadCounter:
_PWM8_CLK_bReadCounter:
 bPWM8_CLK_ReadCounter:                          ; this name deprecated
_bPWM8_CLK_ReadCounter:                          ; this name deprecated
   ...
   mov   A, reg[PWM8_CLK_COMPARE_REG]            ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_CLK_Stop_M                               ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_CLK_INPUT_REG]              ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_CLK_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_CLK_COUNTER_REG]            ; DR2 <- DR0
   mov   A, reg[PWM8_CLK_COMPARE_REG]            ; Stash the Count on the stack
   ...
   mov   reg[PWM8_CLK_INPUT_REG], A              ;
   M8C_SetBank0                                  ;
   PWM8_CLK_Start_M                              ;   then re-enable the PWM.
