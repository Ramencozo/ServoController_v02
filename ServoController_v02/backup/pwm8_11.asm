...
;  Global Symbols
;-----------------------------------------------
export  PWM8_11_EnableInt
export _PWM8_11_EnableInt
export  PWM8_11_DisableInt
export _PWM8_11_DisableInt
export  PWM8_11_Start
export _PWM8_11_Start
export  PWM8_11_Stop
export _PWM8_11_Stop
export  PWM8_11_WritePeriod
export _PWM8_11_WritePeriod
export  PWM8_11_WritePulseWidth
export _PWM8_11_WritePulseWidth
export  PWM8_11_bReadPulseWidth
export _PWM8_11_bReadPulseWidth
export  PWM8_11_bReadCounter
export _PWM8_11_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_11_ReadPulseWidth    ; deprecated
export _bPWM8_11_ReadPulseWidth    ; deprecated
export  bPWM8_11_ReadCounter       ; deprecated
export _bPWM8_11_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM8_11_WritePeriod:
_PWM8_11_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_11_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_11_WritePulseWidth:
_PWM8_11_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_11_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_11_bReadPulseWidth:
_PWM8_11_bReadPulseWidth:
 bPWM8_11_ReadPulseWidth:                        ; this name deprecated
_bPWM8_11_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_11_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_11_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_11_bReadCounter:
_PWM8_11_bReadCounter:
 bPWM8_11_ReadCounter:                           ; this name deprecated
_bPWM8_11_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM8_11_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_11_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_11_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_11_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_11_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM8_11_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM8_11_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM8_11_Start_M                               ;   then re-enable the PWM.
