...
;  Global Symbols
;-----------------------------------------------
export  PWM8_10_EnableInt
export _PWM8_10_EnableInt
export  PWM8_10_DisableInt
export _PWM8_10_DisableInt
export  PWM8_10_Start
export _PWM8_10_Start
export  PWM8_10_Stop
export _PWM8_10_Stop
export  PWM8_10_WritePeriod
export _PWM8_10_WritePeriod
export  PWM8_10_WritePulseWidth
export _PWM8_10_WritePulseWidth
export  PWM8_10_bReadPulseWidth
export _PWM8_10_bReadPulseWidth
export  PWM8_10_bReadCounter
export _PWM8_10_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_10_ReadPulseWidth    ; deprecated
export _bPWM8_10_ReadPulseWidth    ; deprecated
export  bPWM8_10_ReadCounter       ; deprecated
export _bPWM8_10_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM8_10_WritePeriod:
_PWM8_10_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_10_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_10_WritePulseWidth:
_PWM8_10_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_10_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_10_bReadPulseWidth:
_PWM8_10_bReadPulseWidth:
 bPWM8_10_ReadPulseWidth:                        ; this name deprecated
_bPWM8_10_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_10_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_10_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_10_bReadCounter:
_PWM8_10_bReadCounter:
 bPWM8_10_ReadCounter:                           ; this name deprecated
_bPWM8_10_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM8_10_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_10_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_10_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_10_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_10_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM8_10_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM8_10_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM8_10_Start_M                               ;   then re-enable the PWM.
